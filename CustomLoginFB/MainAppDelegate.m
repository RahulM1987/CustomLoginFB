...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CustomLogin *customLoginViewController = [[CustomLogin alloc] init];
    ...
    if (FBSession.activeSession.state == FBSessionStateCreatedTokenLoaded) {
        ...
        UIButton *login = [self.customLoginViewController login];
        [login setTitle:@"Log in with Facebook" forState:UIControlStateNormal];
    }
    return YES;
}
